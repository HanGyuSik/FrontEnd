...
//     console.log(`${s}는 회문`)
// }else{
//     console.log(`${s}는 회문이 아니다`)
//   }


// // 삼항연산자로 판단
// // 조건식?참:거짓
// (s == sr) ? console.logconsole.log(`${s}는 회문`) : console.log(`${s}는 회문이 아니다`);
...
let pos = 0;
let cnt = 0;
// s.includes("HTML");   //유무에 따라 true, flase
// str = s.indexOf("HTML");    // 유무에 따라 위치값 또는 -1 출력
// console.log(str);
